...
$pageTitle       = 'Egresos y Graduación';
...
$breadcrumbs = [
    ...
    ['label' => 'Egresos y Graduación', 'url' => null],
];
...
document.addEventListener('DOMContentLoaded', function () {
  const checkAll  = document.getElementById('checkAllEgresos');
  const checks    = document.querySelectorAll('.check-egreso:not(:disabled)');
  const btnMasivo = document.getElementById('btnGraduacionMasiva');

  function actualizarBotonMasivo() {
    const seleccionados = document.querySelectorAll('.check-egreso:checked').length;
  ...
  btnMasivo.addEventListener('click', function () {
    const ids = Array.from(document.querySelectorAll('.check-egreso:checked')).map(function (c) {
      return c.value;
    });
    ...
    form.method = 'POST';
    form.action = '<?= BASE_URL ?>egresos/graduarMasivo';
