...
<p class="text-support mb-4">Ingrese los datos del documento de identidad del estudiante.</p>
...
<div class="row g-3 mb-4">
  ...
  <div class="col-md-4">
    <label class="form-label" for="numeroDocumento">N° Cédula / Pasaporte *</label>
...
<div class="row g-3 mb-4">
  <div class="col-md-6">
    ...
    <input type="text" class="form-control" id="primerNombre" name="primer_nombre"
           placeholder="Ej: María" required>
  </div>
  <div class="col-md-6">
    <label class="form-label" for="segundoNombre">Segundo Nombre (Opcional)</label>
...
<p class="text-support mb-4">Seleccione el sexo del estudiante.</p>
